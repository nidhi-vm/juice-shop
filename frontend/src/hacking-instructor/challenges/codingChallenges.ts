  ...
  hints: [
    {
      ...
      fixtureAfter: true,
      unskippable: true,
      resolved: waitForAngularRouteToBeVisited('score-board') // The tutorial does not progress automatically. Workaround instruction above should be removed when fixed.
    },
    {
      text:
