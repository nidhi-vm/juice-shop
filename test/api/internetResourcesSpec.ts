...
describe('Required Internet resource', () => { // Tests fail regularly (but not always) from ECONNRESET
  describe('PasteBin paste for "Leaked Unsafe Product" challenge available', () => {
    ...
    it('for 7MS configuration (https://pastebin.com/8SMbWPxc)', () => { // Test would need to confirm/bypass PasteBin SMART filter to retrieve content
    ...
    it('for Mozilla configuration (https://pastebin.com/t8jqE1y7)', () => { // Test would need to confirm/bypass PasteBin SMART filter to retrieve content
