describe('/#/forgot-password', () => {
  ...
  const resetPasswordForUser = (email: string, securityAnswer: string, newPassword: string, challenge: string) => {
  ...
  describe('as Jim', () => {
    it('should be able to reset password with his security answer', () => {
      resetPasswordForUser('jim', 'Samuel', 'I <3 Spock', "Reset Jim's Password")
    })
  })

  describe('as Bender', () => {
    it('should be able to reset password with his security answer', () => {
      resetPasswordForUser('bender', "Stop'n'Drop", 'Brannigan 8=o Leela', "Reset Bender's Password")
    })
  })
  ...
  describe('as Bjoern', () => {
    describe('for his internal account', () => {
      it('should be able to reset password with his security answer', () => {
        resetPasswordForUser('bjoern', 'West-2082', 'monkey birthday ', "Reset Bjoern's Password")
      })
    })
  ...
  describe('as Morty', () => {
    it('should be able to reset password with his security answer', () => {
      resetPasswordForUser('morty', '5N0wb41L', 'iBurri3dMySe1f!', "Reset Morty's Password")
    })
  })

  describe('as Uvogin', () => {
    it('should be able to reset password with his security answer', () => {
      resetPasswordForUser('uvogin', 'Silence of the Lambs', 'ora-ora > muda-muda', "Reset Uvogin's Password")
    })
  })
})