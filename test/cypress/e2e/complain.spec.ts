describe('/#/complain', () => {
  ...
  describe('challenge "uploadSize"', () => {
    it('should be possible to upload files greater 100 KB directly through backend', async () => {
      const over100KB = Array.from({ length: 11000 }, () => '1234567890');
  ...
  describe('challenge "uploadType"', () => {
    it('should be possible to upload files with other extension than .pdf directly through backend', async () => {
      const data = new FormData();
