...
function verifySecurityAnswerChallenges(user: UserModel, answer: string) {
  ...
  handleGeoStalkingChallenges(user, answer)
}

function handleGeoStalkingChallenges(user: UserModel, answer: string) {
...
function getSecurityAnswer(answerKey: string): string | undefined {
